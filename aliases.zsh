...
alias multipull="find . -mindepth 1 -maxdepth 1 -type d -print -exec git -C {} pull origin main \; && cd ~/src/postalio/local-fe-docker/ && docker-compose pull && cd .."
...
alias gf="git fetch"
alias ygt="yes | gt sync"
alias gtcom="gt checkout main"
